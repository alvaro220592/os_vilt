<template>
    <main :isOpen="isOpen" :class="isOpen ? 'w-[calc(100%-3rem)] md:w-[calc(100%-12rem)]' : 'w-[calc(100%-3rem)]'" class="ml-auto min-h-screen bg-orange-500 md:transition-all md:duration-500">
